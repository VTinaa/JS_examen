...
//         let imgURL = `https://starwars-visualguide.com/assets/img/species/${element.url.match(/\/([0-9]*)\/$/)[1]}.jpg`
...
//     const {name,classification,designation,language,average_lifespan,average_height} =data
...
function showAllPerson(data) {
    ...
    data.forEach(async (element) => {
        try {
            const imgURL = `https://starwars-visualguide.com/assets/img/species/${element.url.match(/\/([0-9]*)\/$/)[1]}.jpg`;
            let img = new Image();
            img.src = imgURL;
            img.onerror = () => {
