...
//         let imgURL = `https://starwars-visualguide.com/assets/img/vehicles/${element.url.match(/\/([0-9]*)\/$/)[1]}.jpg`
...
//     const {name,model,manufacturer,vehicle_class,cost_in_credits,max_atmosphering_speed} =data
...
function showAllPerson(data) {
    ...
    data.forEach(async (element) => {
        try {
            const imgURL = `https://starwars-visualguide.com/assets/img/vehicles/${element.url.match(/\/([0-9]*)\/$/)[1]}.jpg`;
            let img = new Image();
            img.src = imgURL;
            img.onerror = () => {
